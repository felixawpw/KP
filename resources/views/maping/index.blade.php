          				...
          				<table class="table table-striped" data-toggle="table" data-pagination="true" data-search="true" data-url="/table/json/maping">
							<thead>
								<tr class="warning">
									...
									<th data-field="nrp">Edit</th>
									<th data-field="nrp" data-formatter="LinkFormatter">Delete</th>
								</tr>
							</thead>
							<tbody>
...
<script type="text/javascript">
	function EditFormatter(value, row, index){
		return '<a href="/maping/'+ row['nrp']+ '/edit">Edit</a>'
	}

	function DeleteFormatter(value, row, index) {
		return '<form method="post" action="/maping/'+ row['nrp'] + '">' +
				'{{csrf_field()}}' +
				'@method("DELETE")' +
